...
namespace Package\Difference\Fun\Log\Controller;
...
class Cli extends Controller {
    ...
    const INFO = [
        '{{binary()}} difference_fun/log                     | log options',
        '{{binary()}} difference_fun/log setup               | Log setup',
        '{{binary()}} difference_fun/log archive <archive>   | Zip <archive> into <archive>.{literal}{date(\'Y-m-d H:i:s\')}{/literal}.log.zip',
    ];
